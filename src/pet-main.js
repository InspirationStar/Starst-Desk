// ============================================================
// Starst Desk 桌宠渲染进程入口（轻量 Vue 应用）
// 职责：创建独立于主应用与小部件的 Vue 实例，注册 Pinia + Element Plus，挂载到 #pet-app
// 不加载主应用路由、侧边栏，保持桌宠窗口体积最小
...
// 全局错误捕获：桌宠渲染期间抛出的错误统一处理
app.config.errorHandler = (err, instance, info) => {
  console.error('[Pet] 组件错误:', err, info)
}

// 挂载应用到 DOM 节点 #pet-app
app.mount('#pet-app')